...
namespace CoreClass
{
	...
	public class OperateMemoryClass
	{
		...
		*/
		...
		public void AlertMsg(Page page, string message)
		{
			page.ClientScript.RegisterStartupScript(page.GetType(), "AlertMsg", "<script  Language='Javascript'>alert('" + message + "');</script>");
		}
		...
		public void AlertMsg(Page page, string script, bool nothing)
		{
			page.ClientScript.RegisterStartupScript(page.GetType(), "AlertMsg", "<script  Language='Javascript'>" + script + "</script>");
		}
		...
		/// <param name="page">页面类</param>
		/// <param name="message">提示消息</param>
		public void AlertMsg(Page page, string message, string strUrl)
		{
			page.ClientScript.RegisterStartupScript(page.GetType(), "AlertMsg", "<script  Language='Javascript'>alert('" + message + "');location.replace('" + strUrl + "');</script>");
		}
		/*
		============邮件操作模块============
		*/
