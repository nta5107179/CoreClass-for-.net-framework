...
namespace CoreClass
{
	...
	public class SqlProc_MSSQL
	{
		...
		protected bool Execute(string proceName, DataSet ds)
		{
			...
			m_SqlCmd.Parameters.Add(new SqlParameter("@ReturnValue", SqlDbType.Int, 4, ParameterDirection.ReturnValue, false, 0, 0, string.Empty, DataRowVersion.Default, null));
